...
public abstract class AbstractNioConnection implements NioConnection {
	...
	protected static final long DEFAULT_IDLE_TIMEOUT = 180 * 1000000; // 连接默认空闲时间, 3分钟, 单位微秒
	...
	public void write(byte[] data) {
		...
		packet.make(data);
		ByteBuffer byteBuffer = ByteBuffer.allocate(packet.getPacketLength());
		byteBuffer.put(data);
		write(byteBuffer);
	}
